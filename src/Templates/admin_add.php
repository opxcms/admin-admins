...
return [
    ...
    'fields' => [
        ...
        Template::string('admin_admins::name', 'general/common', '', [], '', '', 'admin_admins::view|admin_admins::add'),
        Template::string('email', 'general/common', '', [], '', 'required|email', 'admin_admins::view|admin_admins::add'),
        Template::string('password', 'general/common', '', [], 'fields.info_password', 'nullable|min:6', 'admin_admins::view|admin_admins::add'),
